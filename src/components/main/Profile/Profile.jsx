    ...
    <div>
      <div className={` bg-white  flex flex-col items-center md:mt-16  `}>
        <div className="flex flex-col items-center align-middle justify-center text-center h-[400px]">
          <h1
            className={`font-normal	md:leading-tight text-4xl	md:text-6xl  hero-text ${
              loaded ? "profile" : ""
            }`}>
            Hey 👋🏼 I'm Oli
          </h1>
      ...
      <div className={`flex flex-wrap md:mt-44 `}>
        <div className="flex justify-center flex-wrap  p-5 md:p-0 ">
          <div
            ...
            <img src="/img-12.webp" className="w-full bg-cover " />
          </div>
          <div
      ...
      <div
        className={` bg-white  flex flex-col items-center md:mt-5 -mb-32 md:-mb-5 `}>
        <div className="flex flex-col items-center align-middle justify-center text-center h-[400px]">
          <ul
            className={`md:flex  md:justify-center hero-text ${
              loaded ? "animated" : ""
            }`}>
            <li className="m-2 bg-[#e8e5e480] rounded-full px-[10px] py-[5px] font-light">
              About
            </li>
          </ul>
          <h1
            className={`font-normal	md:leading-tight text-xl	md:text-4xl mb-7 hero-text ${
              loaded ? "profile" : ""
            }`}>
            A freelance designer based in the UK.
            <br /> I combine my experience in product
            <br /> and brand to solve problems, tell stories, and <br />
      ...
      <div className={` bg-white  flex flex-col items-center  `}>
        <div className="flex flex-col items-center align-middle justify-center text-center h-[400px]">
          ...
          <h1
            className={`font-normal	md:leading-tight text-3xl	md:text-4xl mb-7 hero-text ${
              loaded ? "profile" : ""
            }`}>
            Where I've worked
          </h1>
        ...
        <div className="grid md:grid-cols-3  w-[70%] -mt-[6em] mb-5">
          ...
          <Experience
            date={"2017"}
            place={`Agency TK`}
            type={"Senior Digital Designer"}
            position={"Permanent"}
          />
          <Experience
            date={"2012"}
            place={`Agency TK`}
            type={"Digital Designer"}
            position={"Permanent"}
          />
          <Experience
            date={"2009"}
